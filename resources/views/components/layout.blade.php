            ...
            @auth
                ...
                <div class="relative grid place-items-center" x-data="{ open: false }">
                    ...
                    <div x-show="open" @click.outside="open = false"
                        class="bg-white shadow-lg border-r-gray-500 absolute top-10 right-0 rounded-lg overflow-hidden font-light">
                        <p class="font-sans text-md p-2 pl-4 ">{{ auth()->user()->username }}</p>
                        <div
                            class="border-t border-gray-300 block font-bold font-sans text-md hover:bg-slate-100 p-2 pl-4 ">
